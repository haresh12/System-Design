 ...
 *  USEBILITY TESING WEIRD
 *  JEST JSDOM TESTING LIBRARY REACT TESTING LIBRARY
 *  FOR E2E TESTING PUPPETEER IS BEST OF JS AND SELENIUM AND CYPRESS ARE THE ONE THAT ARE MORE FAMOUS
 *  A/B TESTING IS BESTING THINK WE MUST DO IF PRODUCT HAS GOOD NUMBER OF VISTIOR
 *  DATA DRIEN DECISIONS ARE BEST RATHER THEN INTUATION : A/B TESTING
 *  PERFOMNACE TAB , LIGHT HOUSE , PAGEINDEXINSIGHT , WEBPAGETEST.ORG BEST FOR PERFORMANCE TESTING
 *  FOR SECURITY TESTING BURP SUIT IS LIT : MUST TRY WITH PAID VERSION
 */